...
```
[*] Session 8ff2ce4c LONG_DRAMATURGE - [::1]:57154 (MacBook-Pro-6.local) - darwin/amd64 - Thu, 20 Jan 2022 1510 CST
...
If you're having problems getting callbacks please see our [troubleshooting guide](/docs?name=Troubleshooting), (TLR add the `--debug` flag when generating an implant).
...
```
[*] Beacon 8c465643 RELATIVE_ADVERTISEMENT - 192.168.1.178:54701 (WIN-1TT1Q345B37) - windows/amd64 - Sat, 22 Jan 2022 1455 CST
...
C:\git
======
drwxrwxrwx a <dir> Wed Dec 22 1556 -0600 2021
...
```
...
========== =========== ============== =============================== =============================== ===============================
 90294ad2 completed Ls Sat, 22 Jan 2022 1400 CST Sat, 22 Jan 2022 1411 CST Sat, 22 Jan 2022 1411 CST
 962978a6 completed Ls Sat, 22 Jan 2022 1443 CST Sat, 22 Jan 2022 1453 CST Sat, 22 Jan 2022 1453 CST
```
...
[*] Session 223fac7e RELATIVE_ADVERTISEMENT - 192.168.1.178:54733 (WIN-1TT1Q345B37) - windows/amd64 - Sat, 22 Jan 2022 1424 CST
```
...
- [Port Forwarding](/docs?nameort%20Forwarding)
