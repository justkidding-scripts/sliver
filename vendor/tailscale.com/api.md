...
```jsonc
{
 ...
 // and IPv6 (formatted as fd7aa1e0bd:e) addresses.
 "addresses": ["100.87.74.78", "fd7aa1e04843697d:c36e"],
 ...
 // Learn more about machine names at https/tailscale.com/kb/109.
 "hostname": "pangolin",
 ...
 // network conditions.
 "clientConnectivity": {
 // endpoints (array of strings) Client's magicsock UDP IPort
 ...
 // external devices.
 // Learn more about tags at https/tailscale.com/kb/106.
 "tags": ["tag:golink"],
...
Learn more about [tags](https/tailscale.com/kb/106).
...
When a device is added to a tailnet, its key expiry is set according to the tailnet's [key expiry](https/tailscale.com/kb/102) setting.
...
[user roles](https/tailscale.com/kb/113user-roles) Owners, Admins, Network Admins, or IT Admins.
...
Learn more about [network access controls](https/tailscale.com/kb/101).
...
Learn about the [ACL policy properties you can include in the request](https/tailscale.com/kb/101#tailscale-policy-syntax).
...
Read about [previewing changes in the admin console](https/tailscale.com/kb/101#previewing-changes).
...
Learn about [tailnet policy file entries](https/tailscale.com/kb/101.
...
- **Run ACL tests:** When the **request body contains ACL tests as a JSON array**,
 ...
 Learn more about [ACL tests](https/tailscale.com/kb/101#tests).
...
Learn more about [tailnet policy file tests](https/tailscale.com/kb/101#tests).
...
```jsonc
{
 ...
 // with this key.
 // Learn about tags at https/tailscale.com/kb/106.
 "tags": [
 "tag:example"
 ]
 }
...
```jsonc
{
 ...
 "created": "2021-12-09T2339Z",
 "expires": "2022-03-09T2339Z",
 "revoked": "2022-03-12T2339Z",
 "capabilities": {
 "devices": {
 "create": {
 "reusable": false,
...
{
 "id": "abc123456CNTRL",
 "created": "2022-05-05T1844Z",
 "expires": "2022-08-03T1844Z",
 "capabilities": {
 "devices": {
 "create": {
 "reusable": false,
